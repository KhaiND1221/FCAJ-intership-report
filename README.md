...
**📍 Live Demo: [View Report](https://KhaiND1221.github.io/FCAJ-intership-report/)**
...
Welcome to my **FCJ Internship Report**! This web application documents my 12-week journey as a **Security Engineer** at **Amazon Web Services Vietnam** with **Team NeuraX**. It serves as a comprehensive portfolio, tracking my weekly progress, technical workshops, events participated, and self-evaluation.
...
```
FCAJ-intership-report/
├── 📁 content/              # Markdown content (en/vi)
│   ├── 📁 worklog/          # Weekly updates (week-01 to week-12)
...
git clone https://github.com/KhaiND1221/FCAJ-intership-report.git
cd FCAJ-intership-report
...
[![GitHub](https://img.shields.io/badge/GitHub-KhaiND1221-181717?style=flat-square&logo=github)](https://github.com/KhaiND1221)
