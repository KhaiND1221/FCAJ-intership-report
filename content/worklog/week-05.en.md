...
| --- | --- | --- | --- | --- |
| 1 | - Application Protection Setup <br>&emsp; + Provision AWS WAF Web ACLs <br>&emsp; + Attach Web ACLs to CloudFront distribution | 26/02/2026 | 26/02/2026 | [Application Protection with AWS WAF](https://000026.awsstudygroup.com) |
| 2 | - Common Vulnerability Defense <br>&emsp; + Import AWS Managed Rules (Core rule set, SQLi, XSS) <br>&emsp; + Customize rules to reduce false positives for the API | 27/02/2026 | 27/02/2026 |  |
| 3 | - DDoS Mitigation <br>&emsp; + Configure rate-based rules (e.g., 500 requests / 5 mins) <br>&emsp; + Enable AWS Shield Standard to protect against Layer 3/4 attacks | 28/02/2026 | 28/02/2026 |  |
| 4 | - WAF Logging & Analytics <br>&emsp; + Route WAF logs to CloudWatch logs / S3 <br>&emsp; + Explore requests visualization | 01/03/2026 | 01/03/2026 | [CloudWatch Logs] |
| 5 | - WAF Policy Testing <br>&emsp; + Manually test payloads using `curl` and Burp Suite <br>&emsp; + Verify 403 Forbidden responses on malevolent requests | 02/03/2026 | 02/03/2026 |  |
| 6-7 | - Rule Optimization <br>&emsp; + Review flagged logs from the dev team's traffic <br>&emsp; + Adjust filtering modes properly | 03/03/2026 | 04/03/2026 | [Audit Logs] |
